  ...
  return (
    <div className='bg-[#F6F9FC]text-gray-500/80 pt-8 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center gap-3 mt-4'>
                       ...
                       <img src={assets.twitterIcon} alt="Tweitter-Icon" className='w-6' />
            
                    </div>
                </div>

                <div className='font-playfair text-lg text-gray-800'>
                ...
                <div className='max-w-80'>
                    <p className=' font-palyfair text-lg text-gray-800'>STAY UPDATED</p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="https://easiland.com">Easiland</a>. All rights reserved.</p>
