...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='List Room' subTitle='View and manage your hotel rooms. Keep the information up-to-date to provide the best experience for users.' />
                  ...
                  <td className='py-3 px-4 border-t border-gray-300 text-center'>
                    <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                      <input onChange={() => toggleAvailability(item._id)}
                        type="checkbox" className='sr-only peer' checked={item.isAvailable} readOnly />
...
//   return (
//     <div>
//         <Title align='left' font='outfit' title='List Room' subTitle='View and manage your hotel rooms. 
//         Keep the information up-tp-date to provide the best experience for users.'/>
//         <p className='text-gray-500 mt-8'>All Rooms</p>
