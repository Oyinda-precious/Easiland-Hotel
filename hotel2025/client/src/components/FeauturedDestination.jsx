...
const FeauturedDestination = () => {
  ...
  return (
    ...
    <Title title='Featured Destination' subTitle='Discover our handpicked selection of exceptional
     properties around the world, offering unparalled luxry and unforgettable experiences.'/>
    ...
    className='my-16 py-2 text-sm font-medium border border-gray-300 rounded bg-white 
    hover:bg-gray-50 transition-all w-50 cursor-pointer'>
